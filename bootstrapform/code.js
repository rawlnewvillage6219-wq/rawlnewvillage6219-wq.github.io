function checkemail()
{
    ...
    if(email == "") //conditional expression, when true, then the code in the block will be executed
    {
    ...
    if(confirm == "") //conditional expression, when true, then the code in the block will be executed
    {
    ...
    //check if both textboxes the same value
